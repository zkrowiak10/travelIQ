class ObservableObject {
    ...
    handler = {
        get: (target: any, property: string, receiver: any) => {
            ...
            if (property == "_observableObject") { return this; }
            if (property == "$parentModel") { return this.$parentModel; }
    ...
    updateOnStateChangeByOref(oRefParent: any, property: string | number | symbol) {
    ...
    updateArrayOnSet(targetArr: any[], targetProperty: string, value: any) {
        ...
        if (boundElement) {
            ...
            if (!(insertNode instanceof HTMLElement)) {
                throw new Error(`Template node is note of type HTMLElement`)
            }
            let subModel : any = {}
